...
var BuildId = "prKddKy5GwGL5u_gHBuBU";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }], "dynamic": [{ "page": "/api/v1/router/catalog/[modelId]", "regex": "^/api/v1/router/catalog/([^/]+?)(?:/)?$", "routeKeys": { "nxtPmodelId": "nxtPmodelId" }, "namedRegex": "^/api/v1/router/catalog/(?<nxtPmodelId>[^/]+?)(?:/)?$" }, { "page": "/api/v1/router/explanations/[requestId]", "regex": "^/api/v1/router/explanations/([^/]+?)(?:/)?$", "routeKeys": { "nxtPrequestId": "nxtPrequestId" }, "namedRegex": "^/api/v1/router/explanations/(?<nxtPrequestId>[^/]+?)(?:/)?$" }, { "page": "/api/v1/user/gateways/[gatewayId]", "regex": "^/api/v1/user/gateways/([^/]+?)(?:/)?$", "routeKeys": { "nxtPgatewayId": "nxtPgatewayId" }, "namedRegex": "^/api/v1/user/gateways/(?<nxtPgatewayId>[^/]+?)(?:/)?$" }, { "page": "/api/v1/user/gateways/[gatewayId]/fetch-models", "regex": "^/api/v1/user/gateways/([^/]+?)/fetch\\-models(?:/)?$", "routeKeys": { "nxtPgatewayId": "nxtPgatewayId" }, "namedRegex": "^/api/v1/user/gateways/(?<nxtPgatewayId>[^/]+?)/fetch\\-models(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/v1/models/route": "/api/v1/models", "/api/v1/router/scorecard/current/route": "/api/v1/router/scorecard/current", "/api/v1/user/gateways/[gatewayId]/fetch-models/route": "/api/v1/user/gateways/[gatewayId]/fetch-models", "/api/v1/user/gateways/[gatewayId]/route": "/api/v1/user/gateways/[gatewayId]", "/api/v1/user/gateways/route": "/api/v1/user/gateways", "/api/v1/admin/verify/route": "/api/v1/admin/verify", "/api/v1/auth/logout/route": "/api/v1/auth/logout", "/api/v1/auth/login/route": "/api/v1/auth/login", "/api/v1/completions/route": "/api/v1/completions", "/api/v1/auth/signup/route": "/api/v1/auth/signup", "/api/v1/router/catalog/[modelId]/route": "/api/v1/router/catalog/[modelId]", "/api/v1/chat/completions/route": "/api/v1/chat/completions", "/api/v1/responses/route": "/api/v1/responses", "/api/v1/router/kv-debug/route": "/api/v1/router/kv-debug", "/api/v1/router/catalog/route": "/api/v1/router/catalog", "/api/v1/router/config/route": "/api/v1/router/config", "/api/v1/router/runs/route": "/api/v1/router/runs", "/api/v1/router/explanations/[requestId]/route": "/api/v1/router/explanations/[requestId]", "/api/v1/router/recompute/route": "/api/v1/router/recompute", "/api/v1/user/keys/route": "/api/v1/user/keys", "/api/v1/user/me/route": "/api/v1/user/me", "/login/page": "/login", "/page": "/", "/admin/page": "/admin" };
